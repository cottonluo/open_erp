...
var _symbolExtractor = require("../../lib/semantic-model/symbol-extractor");
...
describe("SymbolExtractor", function () {
	...
	describe("Program", function () {
		it("assigns the global scope to the program statement", function () {
			...
			// assert
			(0, _chai.expect)(ast.program.scope).to.equal(program.globalScope);
		});
	});
	...
	describe("Statements", function () {
		describe("EmptyStatement", function () {
			it("supports empty statements", function () {
				// act, assert
				(0, _chai.expect)(() => extractSymbols(";")).not.to.throw();
			});
		});
		...
		describe("BlockStatement", function () {
			it("creates a new scope and assigns it to the node", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.body[0].scope).to.be.instanceOf(_scope.Scope);
				(0, _chai.expect)(ast.program.body[0].scope).not.to.equal(program.globalScope);
			});
			...
			it("leaves the child scope after visiting the block statement", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.body[0].scope).not.to.have.ownSymbol("x");
				(0, _chai.expect)(program.globalScope).to.have.ownSymbol("x");
			});
		});
		...
		describe("ExpressionStatement", function () {
			it("registers identifiers directly used inside the expression of an expression statement in the scope", function () {
				...
				(0, _chai.expect)(scope).to.have.ownSymbol("x");
			});
			...
			it("assigns the symbol with the identifier node for identifiers directly used inside of an expression statement", function () {
				...
				// assert
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].expression)).not.to.be.undefined;
			});
		});
		...
		describe("IfStatement", function () {
			...
			it("assigns the symbol to the identifier node in the test expression", function () {
				...
				// assert
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].test)).not.to.be.undefined;
			});
		});
		...
		describe("LabeledStatement", function () {
			it("is supported", function () {
				// act, assert
				(0, _chai.expect)(() => extractSymbols("x: y;")).not.to.throw();
			});
		});
		...
		describe("SwitchStatement", function () {
			it("registers the identifiers in the discriminant expression", function () {
				...
				const scope = ast.program.scope;
				(0, _chai.expect)(scope).to.have.ownSymbol("x");
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].discriminant)).not.to.be.undefined;
			});
		});
		...
		describe("ReturnStatement", function () {
			it("adds an identifier used in the return statement to the current scope", function () {
				...
				(0, _chai.expect)(scope).to.have.ownSymbol("y");
			});
			...
			it("assigns the symbol to the identifier used directly in the return statement", function () {
				...
				// assert
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].body.body[0].argument)).not.to.be.undefined;
			});
		});
		...
		describe("ThrowStatement", function () {
			it("registers the identifiers in the argument expression", function () {
				...
				const scope = ast.program.scope;
				(0, _chai.expect)(scope).to.have.ownSymbol("x");
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].argument)).not.to.be.undefined;
			});
		});
		...
		describe("ForStatement", function () {
			it("adds identifiers used in the init, test or update expression to the current scope", function () {
				...
				// assert
				(0, _chai.expect)(program.globalScope).to.have.ownSymbol("x");
				(0, _chai.expect)(program.globalScope).to.have.ownSymbol("y");
				(0, _chai.expect)(program.globalScope).to.have.ownSymbol("z");
			});
			...
			it("assigns the symbols with the identifiers used in the init, test or update expression", function () {
				...
				(0, _chai.expect)(program.symbolTable.getSymbol(forStatement.init)).to.be.defined;
				(0, _chai.expect)(program.symbolTable.getSymbol(forStatement.test)).to.be.defined;
				(0, _chai.expect)(program.symbolTable.getSymbol(forStatement.update)).to.be.defined;
			});
		});
		...
		describe("ForInStatement", function () {
			it("registers the identifiers in the left hand side expression", function () {
				...
				const scope = ast.program.scope;
				(0, _chai.expect)(scope).to.have.ownSymbol("x");
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].left)).not.to.be.undefined;
			});
			...
			it("registers the identifiers in the right hand side expression", function () {
				...
				const scope = ast.program.scope;
				(0, _chai.expect)(scope).to.have.ownSymbol("y");
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].right)).not.to.be.undefined;
			});
		});
	...
	describe("Expressions", function () {
		...
		describe("ThisExpression", function () {
			it("creates a new symbol for the first usage of this in a function", function () {
				...
				(0, _chai.expect)(scope).to.have.ownSymbol("this");

				const thisExpression = func.body.body[0].expression.left.object;
				(0, _chai.expect)(program.symbolTable.getSymbol(thisExpression)).not.to.be.undefined;
			});
			...
			it("reuses the previously defined this symbol", function () {
				...
				(0, _chai.expect)(program.symbolTable.getSymbol(secondThis)).to.equal(program.symbolTable.getSymbol(firstThis));
			});
			...
			it("resolves the this from the function scope and not from the current scope", function () {
				...
				(0, _chai.expect)(subBlock.scope).not.to.have.ownSymbol("this");
				(0, _chai.expect)(program.symbolTable.getSymbol(secondThis)).to.equal(program.symbolTable.getSymbol(firstThis));
			});
			...
			it("does not throw if this is used outside a function declaration", function () {
				...
				(0, _chai.expect)(scope).to.have.ownSymbol("this");
				(0, _chai.expect)(program.symbolTable.getSymbol(thisStatement)).not.to.be.undefined;
			});
		});
		...
		describe("ArrayExpression", function () {
			it("sets the symbols for identifiers used in the array", function () {
				...
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("p1");
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("p2");

				const arrayExpression = ast.program.body[0].expression;
				(0, _chai.expect)(program.symbolTable.getSymbol(arrayExpression.elements[0])).not.to.be.undefined;
				(0, _chai.expect)(program.symbolTable.getSymbol(arrayExpression.elements[1])).not.to.be.undefined;
			});
		});
		...
		describe("FunctionDeclaration", function () {
			it("creates a new child scope and assigns it to the function node", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.body[0].scope).to.be.ok;
				(0, _chai.expect)(ast.program.body[0].scope).not.to.equal(program.globalScope);
			});
			...
			it("leaves the child scope after the function declaration", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("x");
			});
			...
			it("creates a symbol for each parameter in the scope of the function", function () {
				...
				(0, _chai.expect)(scope).to.have.ownSymbol("current");
				(0, _chai.expect)(scope).to.have.ownSymbol("intend");
			});
			...
			it("sets the declaration for a parameter symbol to the identifier node of the parameter", function () {
				...
				(0, _chai.expect)(scope.getOwnSymbol("current")).to.have.property("declaration", ast.program.body[0].params[0]);
			});
			...
			it("sets the flags for the parameter to Variable", function () {
				...
				(0, _chai.expect)(scope.getOwnSymbol("current")).to.have.property("flags", _symbol.SymbolFlags.Variable);
			});
			...
			it("does not create a symbol for the parameters in the outer scope", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope).not.to.have.ownSymbol("count");
			});
			...
			it("creates a symbol for the function in the outer scope", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("dump");
			});
			...
			it("sets the declaration of the function symbol to the FunctionDeclaration node", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope.getOwnSymbol("dump")).to.have.property("declaration", ast.program.body[0]);
			});
			...
			it("sets the Function and hoisted flag for the FunctionDeclaration", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope.getOwnSymbol("dump")).to.have.property("flags", _symbol.SymbolFlags.Function | _symbol.SymbolFlags.Hoisted);
			});
			...
			it("does not create a symbol for the function in the function scope", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.body[0].scope).not.to.have.ownSymbol("dump");
			});
			...
			it("handles the scopes correctly", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("numbers");
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("even");
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("mapped");
			});
			...
			it("sets the symbol for arrow functions", function () {
				...
				// assert
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].expression.right)).not.to.be.undefined;
			});
			...
			it("uses the same symbol for hoisted functions and references to these", function () {
				...
				(0, _chai.expect)(program.symbolTable.getSymbol(addCall.callee)).to.equal(add);
			});
		});
		...
		describe("VariableDeclarator", function () {
			it("creates a variable symbol in the current scope", function () {
				...
				const scope = ast.program.scope;
				(0, _chai.expect)(scope).to.have.ownSymbol("x");
				(0, _chai.expect)(scope.getOwnSymbol("x")).to.have.property("flags", _symbol.SymbolFlags.Variable);
			});
			...
			it("sets the declarator node as declaration of the symbol", function () {
				...
				// assert
				const scope = ast.program.scope;
				(0, _chai.expect)(scope.getOwnSymbol("x")).to.have.property("declaration", ast.program.body[0].declarations[0]);
			});
			...
			it("sets the valueDeclaration of the symbol the the valueDeclarator.init flag, if present", function () {
				...
				// assert
				const scope = ast.program.scope;
				(0, _chai.expect)(scope.getOwnSymbol("x")).to.have.property("valueDeclaration", ast.program.body[0].declarations[0].init);
			});
			...
			it("uses the same symbol as identifiers used before with the same name", function () {
				...
				// assert
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0])).to.equal(program.symbolTable.getSymbol(ast.program.body[1]));
			});
			...
			it("creates a symbol for identifiers used in the init expression", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("y");
			});
			...
			it("associates the symbol with the identifier node used in the init expression", function () {
				...
				// assert
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].declarations[0].init)).to.have.property("flags", _symbol.SymbolFlags.Variable);
			});
		});
		...
		describe("ObjectExpression", function () {
			it("sets the symbol of the object expression node to the symbol of the variable declaration when the object is directly assigned in a variable declarator", function () {
				...
				(0, _chai.expect)(objectSymbol).to.be.defined;
				(0, _chai.expect)(objectSymbol).to.equal(personSymbol);
			});
			...
			it("sets the symbol of the object expression to the member id to which it is assigned if the object expression is used in an object property", function () {
				...
				(0, _chai.expect)(addressObjectSymbol).to.be.defined;
				(0, _chai.expect)(addressObjectSymbol).to.equal(addressSymbol);
			});
			...
			it("creates a new symbol for an object that is directly passed to a function call", function () {
				...
				(0, _chai.expect)(addressSymbol).to.be.defined;
			});
		});
		...
		describe("ObjectProperty", function () {
			it("adds a symbol with flags Property and declaration equal to the property node as member to the symbol of the object expression", function () {
				...
				(0, _chai.expect)(objectSymbol).to.have.symbolMember("name");
				(0, _chai.expect)(objectSymbol.getMember("name")).to.have.property("flags", _symbol.SymbolFlags.Property);
				(0, _chai.expect)(objectSymbol.getMember("name")).to.have.property("declaration", variableDeclarator.init.properties[0]);
			});
			...
			it("does not add the symbol of the member to the current scope", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope).not.to.have.ownSymbol("name");
			});
			...
			it("associates the symbol with the property node", function () {
				...
				// assert
				const variableDeclarator = ast.program.body[0].declarations[0];
				(0, _chai.expect)(program.symbolTable.getSymbol(variableDeclarator.init.properties[0])).to.be.defined;
			});
		});
		...
		describe("SequenceExpression", function () {
			it("sets the symbols for identifiers used in the expressions", function () {
				...
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("p1");
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("p2");
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("p3");

				const sequenceExpression = ast.program.body[0].expression;
				(0, _chai.expect)(program.symbolTable.getSymbol(sequenceExpression.expressions[0])).not.to.be.undefined;
				(0, _chai.expect)(program.symbolTable.getSymbol(sequenceExpression.expressions[1])).not.to.be.undefined;
				(0, _chai.expect)(program.symbolTable.getSymbol(sequenceExpression.expressions[2])).not.to.be.undefined;
			});
		});
		...
		describe("UnaryExpression", function () {
			it("creates a symbol for the identifier used in the argument to the current scope", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("x");
				(0, _chai.expect)(ast.program.scope.getOwnSymbol("x")).to.have.property("flags", _symbol.SymbolFlags.Variable);
			});
			...
			it("associates the argument node with the symbol", function () {
				...
				// assert
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].expression.argument)).to.be.defined;
			});
		});
		...
		describe("BinaryExpression", function () {
			it("creates a symbol in the current scope for the identifiers used in the left and right hand side", function () {
				...
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("y");
				(0, _chai.expect)(ast.program.scope.getOwnSymbol("y")).to.have.property("flags", _symbol.SymbolFlags.Variable);
			});
			...
			it("assigns the symbol for the left and right hand side with the corresponding identifier nodes", function () {
				...
				(0, _chai.expect)(program.symbolTable.getSymbol(binaryExpression.left)).to.be.equal(ast.program.scope.getOwnSymbol("x"));
				(0, _chai.expect)(program.symbolTable.getSymbol(binaryExpression.right)).to.be.equal(ast.program.scope.getOwnSymbol("y"));
			});
		});
		...
		describe("AssignmentExpression", function () {
			it("creates a symbol for the assignee identifier node and associates it with the assignee", function () {
				...
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("x");
				(0, _chai.expect)(ast.program.scope.getOwnSymbol("x")).to.have.property("flags", _symbol.SymbolFlags.Variable);
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].expression.left)).to.equal(ast.program.scope.getOwnSymbol("x"));
			});
			...
			it("creates a symbol for the member of the assignee  and associates it with the assignee if the assignee is a member expression", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("x");
				(0, _chai.expect)(ast.program.scope.getOwnSymbol("x")).to.have.symbolMember("y");
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].expression.left.property)).to.equal(ast.program.scope.getOwnSymbol("x").getMember("y"));
			});
			...
			it("extracts the identifiers used in the right hand side of the assignment expression", function () {
				...
				// assert
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("z");
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].expression.right)).to.equal(ast.program.scope.getOwnSymbol("z"));
			});
		});
		...
		describe("LogicalExpression", function () {
			...
			it("associates the left and right hand side with the corresponding symbols", function () {
				...
				// assert
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].expression.left)).to.be.equal(program.globalScope.getOwnSymbol("x"));
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].expression.right)).to.be.equal(program.globalScope.getOwnSymbol("y"));
			});
		});
		...
		describe("ConditionalExpression", function () {
			it("sets the symbols for identifiers used in the test, consequent and alternate expression", function () {
				...
				(0, _chai.expect)(program.symbolTable.getSymbol(conditionExpression.test)).not.to.be.undefined;
				(0, _chai.expect)(program.symbolTable.getSymbol(conditionExpression.consequent)).not.to.be.undefined;
				(0, _chai.expect)(program.symbolTable.getSymbol(conditionExpression.alternate)).not.to.be.undefined;
			});
		});
		...
		describe("CallExpression", function () {
			it("creates a symbol for each identifier used in the arguments", function () {
				...
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("z");
				(0, _chai.expect)(ast.program.scope.getOwnSymbol("z")).to.have.property("flags", _symbol.SymbolFlags.Variable);
			});
			...
			it("associates the argument nodes with the corresponding symbols", function () {
				...
				(0, _chai.expect)(program.symbolTable.getSymbol(args[0])).to.be.equal(program.globalScope.getOwnSymbol("x"));
				(0, _chai.expect)(program.symbolTable.getSymbol(args[1])).to.be.equal(program.globalScope.getOwnSymbol("y"));
			});

			it("associates the callee with the symbol of the called function", function () {
				// arrange
				const log = new _symbol.Symbol("log", _symbol.SymbolFlags.Property);
				...
				// assert
				const callExpression = ast.program.body[0].expression;
				(0, _chai.expect)(program.symbolTable.getSymbol(callExpression.callee)).to.be.equal(log);
			});
			...
			it("Can handle member expressions on results of a call expressions", function () {
				...
				// assert
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].expression.callee.object)).not.to.be.undefined;
			});
		});
		...
		describe("MemberExpression", function () {
			it("creates a symbol for the member on the object symbol", function () {
				...
				(0, _chai.expect)(x).to.have.symbolMember("y");
				(0, _chai.expect)(x.getMember("y")).to.have.property("flags", _symbol.SymbolFlags.Property);
			});
			...
			it("creates symbols for nested members", function () {
				...
				(0, _chai.expect)(y).to.have.symbolMember("z");
			});
			...
			it("associates the property node of the member expression with the symbol of the member", function () {
				...
				const x = ast.program.scope.getOwnSymbol("x");
				(0, _chai.expect)(program.symbolTable.getSymbol(memberExpression.property)).to.equal(x.getMember("y"));
			});
			...
			it("associates the object node of the member expression with the symbol of the object", function () {
				...
				const memberExpression = ast.program.body[0].expression;
				const x = ast.program.scope.getOwnSymbol("x");
				(0, _chai.expect)(program.symbolTable.getSymbol(memberExpression.object)).to.equal(x);
			});
			...
			it("creates an anonymous symbol for a literal type e.g. 'test'.length", function () {
				...
				// assert
				const memberExpression = ast.program.body[0].expression;
				(0, _chai.expect)(program.symbolTable.getSymbol(memberExpression.object)).not.to.be.undefined;
			});
			...
			it("associates the property with the computed symbol for computed members", function () {
				...
				(0, _chai.expect)(program.symbolTable.getSymbol(indexedAccess.property)).to.equal(_symbol.Symbol.COMPUTED);
			});
			...
			it("associates the property with a symbol for computed literal members", function () {
				...
				// assert
				const indexedAccess = ast.program.body[1].expression;
				(0, _chai.expect)(program.symbolTable.getSymbol(indexedAccess.property)).not.to.equal(_symbol.Symbol.COMPUTED);
				(0, _chai.expect)(program.symbolTable.getSymbol(indexedAccess.property).name).equal("name");
			});
		});
	});
	...
	describe("Miscellaneous", function () {
		describe("StringLiteral", function () {
			it("are supported", function () {
				// act, assert
				(0, _chai.expect)(() => extractSymbols("x = 'test'")).not.to.throw();
			});
		});
		...
		describe("NumericLiteral", function () {
			it("are supported", function () {
				// act, assert
				(0, _chai.expect)(() => extractSymbols("5")).not.to.throw();
			});
		});
		...
		describe("BooleanLiteral", function () {
			it("are supported", function () {
				// act, assert
				(0, _chai.expect)(() => extractSymbols("true")).not.to.throw();
			});
		});
		...
		describe("NullLiteral", function () {
			it("is supported", function () {
				// act, assert
				(0, _chai.expect)(() => extractSymbols("null")).not.to.throw();
			});
		});

		describe("DirectiveLiteral", function () {
			it("is supported", function () {
				(0, _chai.expect)(() => extractSymbols("'use strict';")).not.to.throw();
			});
		});
		...
		describe("TemplateLiteral", function () {
			it("extracts the identifiers from the expressions", function () {
				...
				(0, _chai.expect)(ast.program.scope).to.have.ownSymbol("user");
				(0, _chai.expect)(program.symbolTable.getSymbol(templateLiteral.expressions[0])).not.to.be.undefined;
			});
		});
	});
	...
	describe("Clauses", function () {
		describe("SwitchCase", function () {
			it("registers the identifiers in the test expression", function () {
				...
				const scope = ast.program.scope;
				(0, _chai.expect)(scope).to.have.ownSymbol("x");
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].cases[0].test)).not.to.be.undefined;
			});
		});
		...
		describe("CatchClause", function () {
			it("registers the identifiers in the catch param expression", function () {
				...
				const scope = ast.program.scope;
				(0, _chai.expect)(scope).to.have.ownSymbol("x");
				(0, _chai.expect)(program.symbolTable.getSymbol(ast.program.body[0].handler.param)).not.to.be.undefined;
			});
		});
	});

	function extractSymbols(source) {
		const ast = (0, _babylon.parse)(source);

		const symbolExtractor = (0, _util.createTraverseVisitorWrapper)(new _symbolExtractor.SymbolExtractor(program));
		(0, _babelTraverse2.default)(ast, symbolExtractor);
		return ast;
	}
});
 ...
 */
_chai.Assertion.addMethod("ownSymbol", function (name) {
	new _chai.Assertion(this._obj).to.be.instanceOf(_scope.Scope);

	this.assert(this._obj.hasOwnSymbol(name), "expected #{this} to be have own symbol #{exp} but got #{act}", "expected #{this} not to contain own symbol #{act}", name, "[" + [...this._obj.symbols].join(", ") + "]");
});

_chai.Assertion.addMethod("symbolMember", function (name) {
	new _chai.Assertion(this._obj).to.be.instanceOf(_symbol.Symbol);

	this.assert(this._obj.hasMember(name), "expected #{this} to have member #{exp} but got #{act}", "expected #{this} not to contain member #{act}", name, "[" + [...this._obj.members.values()].join(", ") + "]");
});
//# sourceMappingURL=symbol-extractor.spec.js.map
