    ...
    <div class="layout">
        ...
        <Menu mode="horizontal" active-name="1">
            <div class="layout-assistant">
                ...
                <Menu-item name="2"><router-link to="/home/finished_stat">成品统计</router-link></Menu-item>
                <Menu-item name="3"><router-link to="/home/half_finished_stat">半成品统计</router-link></Menu-item>
            </div>
        </Menu>
