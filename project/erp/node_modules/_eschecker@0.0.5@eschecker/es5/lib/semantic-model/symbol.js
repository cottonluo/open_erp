...
exports.SymbolFlags = exports.Symbol = undefined;
...
class Symbol {
  ...
  * @param {Symbol} symbol the symbol of the member
     */
	addMember(symbol) {
		(0, _assert2.default)(symbol);
		(0, _assert2.default)(!this.hasMember(symbol), `A member with the name ${ symbol.name } already exists for the symbol ${ this.name }.`);
