...
return baseReduce(collection, baseIteratee(iteratee), accumulator, false, baseEach);
}
...
return typeof value == 'string' ||
  (!isArray(value) && isObjectLike(value) && value.toString() == stringTag);
}
...
const totalLength = lodash.reduce(words, function (sum, word) { return sum + word.length; }, 0);